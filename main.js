...
function prev(){
      ...
      fieldYear.innerHTML = "RAVAL" + inYear;
      num.innerHTML = inNum;
      ...
      ctx.fill();
      ctx.fillStyle = "#fff";
      ctx.fillText("Raval Samaj", 10, 25);
      ctx.font = "16px Arial";
      ctx.fillText("Social Worker", 15, 45);
      ctx.drawImage(logo, 230, 3, 50, 50);
      ctx.fillStyle = "#000";
      ctx.fillText(name.innerHTML, 110, 90);
      ctx.fillText(birth.innerHTML, 110, 115);
      ctx.fillText("Member No:" + fieldYear.innerHTML, 110, 140);
      ctx.fillText("Contact No:" + num.innerHTML, 110, 165);
